...
public class BloodPressureProcess extends Activity {
    ...
    private static int SP = 0, DP = 0, pp=0;
...
/////////////////////////////////////////////////////////////////
            ...
            if (totalTimeInSecs >= 20) {
                ...
                Double wei = bundle.getDouble("wei");
                Double hei1 = bundle.getDouble("hei");
...
//                text.setText(String.valueOf(age));
                ...
                double hei = hei1*2.54;
                double ROB = 17.5;
                double ET = (376-1.22*Beats);
                double BSA = 0.007184*(Math.pow(wei,0.425))*(Math.pow(hei,0.725));
                double SV = (-6.6 + (0.25*(ET-35)) - (0.62*Beats) + (40.4*BSA) - (0.51*age));
                double PP = SV / ((0.013*wei - 0.007*age-0.004*Beats)+1.307);
                double CO =(SV*Beats)/1000;
                double MPP = CO*(ROB);
                double sp = (MPP+((2*PP)/3))+15;
                double dp = sp-PP;
